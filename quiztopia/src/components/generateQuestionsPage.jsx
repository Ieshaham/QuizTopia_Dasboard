        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600">Create custom questions powered by Grok AI</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-700">
                <li>• Enter the subject and grade level for your questions</li>
                <li>• Choose how many questions you want (1-10)</li>
                <li>• Click "Generate Questions" to create them using Grok AI</li>
                <li>• Review and approve questions before saving to database</li>
                <li>• Only approved questions will be saved</li>
              </ul>
            </div>
          </div>
        </div>
